...
public class GruposPesquisa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (pos == 1) {
            ...
            if (str.equals("1")) {
                array_proximo[1] = 1;
                array_mensagem[1] = "100 — ENSINO SUPERIOR";
            }
            else if (str.equals("2")) {
                array_proximo[1] = 60;
                array_mensagem[1] = "200 — PESQUISA";
            }
            else if (str.equals("3")) {
                array_proximo[1] = 74;
                array_mensagem[1] = "300 — EXTENSÃO";
            }
            else if (str.equals("4")) {
                array_proximo[1] = 82;
                array_mensagem[1] = "400 — EDUCAÇÃO BÁSICA E PROFISSIONAL";
            }
            else if (str.equals("5")) {
                array_proximo[1] = 127;
                array_mensagem[1] = "500 — ASSISTÊNCIA ESTUDANTIL";
            }
